...
import ir.dunijet.mahsafood.R
import ir.dunijet.mahsafood.model.Food

class FoodAdapter(private val data:ArrayList<Food>, private val foodEvent: FoodEvent):RecyclerView.Adapter<FoodAdapter.FoodVH> () {


    inner class FoodVH(itemview: View,private val context: Context) : RecyclerView.ViewHolder(itemview) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FoodVH {
        ...
        return FoodVH(view,parent.context)
